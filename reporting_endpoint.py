...
def report_dashboard_general():
    return render_template('reporting/dashboard_general.html')
...
def dashboard_general():
    return report_dashboard_general()
#    data = dashboard_data_paydb()
#    data["premio_stage_balance"] = -1 #utils.int2asset(data["premio_stage_balance"])
#    data["total_balance"] = -1 #utils.int2asset(data["total_balance"])
#    data["claimable_rewards"] = -1 #utils.int2asset(data["claimable_rewards"])
...
#    premio_stage_account = "testingzap001@gmail.com" #app.config['OPERATIONS_ACCOUNT']
